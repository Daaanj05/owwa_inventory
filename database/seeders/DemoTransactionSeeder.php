        ...
        foreach (DemoStockLedgerCatalog::transferRows() as $row) {
            ...
            Transfer::updateOrCreate(
                ...
                [
                    ...
                    'reason_for_transfer' => 'Satellite office replenishment — export mapping fixture',
                    'from_accountable_officer' => 'Supply Custodian',
                    'to_accountable_officer' => 'Laguna Satellite Custodian',
                    ...
                    'received_by_printed_name' => 'Laguna Satellite Custodian',
                    'received_by_designation' => 'Property Custodian',
                    'remarks' => 'PTR demo row for Excel/PDF cell mapping',
                    'recorded_by' => $sc->id,
                ],
            );
        }
