...
class PublicAssetLookupTest extends TestCase
{
    ...
    public function test_public_asset_page_shows_card_layout_with_sticker_fields(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertSee('OVERSEAS WORKERS WELFARE ADMINISTRATION')
            ->assertSee('Regional Office IV-A')
            ->assertSee('Brgy. Parian, Calamba, Laguna')
            ->assertSee('images/bagong-pilipinas-form-logo.png', false)
            ->assertSee('images/owwa-form-logo.png', false)
            ->assertSee('SP Tag No.')
            ...
            ->assertSee('₱500.00')
            ->assertSee('Verified asset record')
